...
public class Modelo {
    ...
    private boolean tiene_instru, disponible;
    private String nombre, apellido, cedula, numTlf, direc, usuario, color, nombre_instrumento, marca_instrumento, serial, fecha_entrega, fecha_devolucion, nombre_docente;
    private int progreso, administrador;
    ...
    private int id_estudiante, id_instru, id_usuario, id_nombre, id_marca, id_docente;
