...
public class Listado_Docentes extends javax.swing.JInternalFrame {

    public Listado_Docentes() {

        initComponents();
        obtenerMatrizDocente();
    ...
    private void initComponents() {
        ...
        ListadoEstu.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, -1, -1));
    ...
    public void obtenerMatrizDocente() {

        OperarDocente docente = new OperarDocente();
        ArrayList<Modelo> miLista = docente.BuscarconMatriz();
